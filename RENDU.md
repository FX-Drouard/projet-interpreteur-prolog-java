...
```
	...
	Dans nos m�thodes, nous v�rifions, surtout pour les deux premiers interpr�tes, que les programmes v�rifient bien les conditions de l'�nonc�. Si ce n'est pas le cas, nous levant l'exception FormatASTNotOK.
	On l�ve cette exception dans interprete0 quand :
		- il y a trop de d�clarations
		- le but est plac� avant le fait (ou il n'y a pas de fait)
